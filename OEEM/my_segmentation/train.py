...
parser = argparse.ArgumentParser(description="Train OEEM Segmentation Model")
...
parser.add_argument('--checkpoint_freq', type=int, default=2, help='epoch to save checkpoints')
parser.add_argument('--val_freq', type=int, default=2, help='epoch to validate')
parser.add_argument('--epochs', type=int, default=500, help='number of epochs to train')
parser.add_argument('--save_dir', type=str, default='./experiments/')
parser.add_argument('--dataset', type=str, choices=['GlaS', 'CRAG'], default='GlaS', help='which dataset be used')
parser.add_argument('--desc', type=str, choices=['CELoss', 'OEEMLoss'], default='OEEMLoss_0919')
...
def main():
    ...
    dsets = {}
    for x in ['train', 'val']:
        img_dir = '/home/data1/my/Project/GlandSegBenchmark/OEEM/my_segmentation/glas_seg/img_train_256_192/'
        target_dir = '/home/data1/my/Project/GlandSegBenchmark/OEEM/my_segmentation/glas_seg/pseudo_train_256_192/'
...
def train(train_loader, model, criterion, optimizer, epoch):
    ...
    for i, sample in enumerate(train_loader):
        ...
        # compute loss
        loss = cross_entropy(o_output, label, criterion, custom_str='oeem')
