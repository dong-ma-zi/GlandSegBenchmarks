...
from models import Swin_MIL, SA_MIL, DWS_MIL

from metrics import iou_metrics, accuracy_pixel_level
...
parser.add_argument('--model_path', type=str,
                    # default="/home/data1/my/Project/GlandSegBenchmark/SA-MIL/weights/DWS_MIL-3/model_best.pth"
                    # default="/home/data1/my/Project/GlandSegBenchmark/SA-MIL/weights/SA_MIL/ep_200.pth"
                    default="/home/data1/my/Project/GlandSegBenchmark/SA-MIL/weights/Swin_MIL-2/model_best.pth"
                    )
...
def main():
    ...
    # load model
    model = Swin_MIL(class_num=2)
    # model = SA_MIL(class_num=2)
    # model = DWS_MIL(class_num=2)
    ...
    for img_name in img_names:
        ...
        for scale in [1, 1.25, 1.5, 1.75, 2]:
            image_per_scale_path = '/home/data1/my/Project/GlandSegBenchmark/OEEM/classification/glas_valid/crop_images_112_96/' + \
                                   name + \
                                   '/' + str(scale)
            scale = float(scale)
            w_ = int(w * scale)
        ...
        if eval_flag:
            ...
            result = accuracy_pixel_level(np.expand_dims(pred > 0, 0), np.expand_dims(label_img > 0, 0))
            pixel_accu = result[0]
