...
class Vit_SAM(nn.Module):
    ...
    def __init__(
        ...
        self.image_encoder = ImageEncoderViT(img_size=1024, patch_size=16, use_abs_pos=True)
        self.pe_layer = PositionEmbeddingRandom(128)
        self.mask_decoder = MaskDecoder(num_multimask_outputs=1,
    ...
    def forward(self, x):
        ...
        out, _ = self.mask_decoder(image_embeddings=image_embedding.unsqueeze(1),
                                   image_pe=img_pe, )
