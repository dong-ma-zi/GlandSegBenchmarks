...
class Options:
    def __init__(self, isTrain):
        ...
        # --- training params --- #
        self.train = dict()
        self.train['data_dir'] = '/home/data2/MedImg/GlandSeg/{:s}/train/250/patches'.format(self.dataset)  # path to data
        ...
        self.train['num_epochs'] = 1000  # number of training epochs
        ...
        self.train['gpu'] = [2, ]        # select gpu devices
        ...
        self.test['gpu'] = [3, ]
        # self.test['img_dir'] = '/home/data2/MedImg/GlandSeg/{:s}/valid/Images'.format(self.dataset)
        # self.test['label_dir'] = '/home/data2/MedImg/GlandSeg/{:s}/valid/Annotation'.format(self.dataset)
        self.test['img_dir'] = '/home/data2/MedImg/GlandSeg/{:s}/test/Images'.format(self.dataset)
        self.test['label_dir'] = '/home/data2/MedImg/GlandSeg/{:s}/test/Annotation'.format(self.dataset)
        self.test['tta'] = True
        self.test['save_flag'] = True
        # self.test['patch_size'] = 0 if self.dataset == 'GlaS' else 208
        self.test['patch_size'] = 0
        ...
        self.post['min_area'] = 100   # minimum area for an object
        self.post['radius'] = 4
    ...
    def parse(self):
        ...
        if self.isTrain:
            ...
            if self.dataset == 'GlaS' or self.dataset == 'CRAG':
