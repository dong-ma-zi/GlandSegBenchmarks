...
parser.add_argument('--desc', type=str, default='SwinUnet')
...
def main():
    ...
    # ----- create model ----- #
    model = SwinTransformerSys(img_size=448, num_classes=2)
    ...
    data_path = {'train': '/home/data2/MedImg/NucleiSeg/MoNuSeg/extracted_mirror/train/448x448_224x224/',
