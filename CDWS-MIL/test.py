...
from utils.utils import accuracy_pixel_level
...
parser.add_argument('--model_path', type=str,
                    default="/home/data1/my/Project/GlandSegBenchmark/CDWS-MIL/exp/vgg_0925/model_300.pth"
                    # default="/home/data1/my/Project/GlandSegBenchmark/CDWS-MIL/result/vgg_500.pth"
                    )
        ...
        for scale in [1, 1.25, 1.5, 1.75, 2]:
            ...
            with torch.no_grad():
                ...
                for img_path in glob.glob(os.path.join(image_per_scale_path, '*.png')):
                    ...
                    cam_scores = model(img, infer=True)
