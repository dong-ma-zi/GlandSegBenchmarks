...
def parse_args():    
    ...
    parser.add_argument('-exp_name', type=str, default='sam-h-1024-16-256', help='net type')
    ...
    parser.add_argument('-sam_ckpt', default="/home/data1/my/Project/segment-anything-main/sam_vit_h.pth",
