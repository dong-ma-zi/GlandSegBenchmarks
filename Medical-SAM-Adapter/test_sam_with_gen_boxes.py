...
parser.add_argument('--save_dir', type=str, default='./experimentsBoxes2')
...
parser.add_argument('--desc', type=str,
                    # default='SAM-vit-h',
                    default='SAM-vit-b-with-auto-boxes',
                    )

parser.add_argument('--model_path', type=str,
                    # glas orig sam
                    # glas adpt sam
                    # default="/home/data1/my/Project/GlandSegBenchmark/Medical-SAM-Adapter/logs_box_p/glas-samAdpt-b-1024-16-256_2023_11_03_14_23/Model/checkpoint_200.pth"
                    # default="/home/data1/my/Project/GlandSegBenchmark/Medical-SAM-Adapter/logs_box_p/glas-samAdpt-h-1024-16-256_2023_11_03_14_25/Model/checkpoint_150.pth"
                    # monuseg orig sam
                    # monuseg adpt sam
...
def main():
    ...
    for img_name in img_names:
        ...
        # boxes_orig_scale, masks = generate_boxes_prompt_all_inst(label_img)
        # with open(os.path.join('/home/data1/my/Project/yolov5/runs/detect/exp7/labels/', name + '.txt'), 'r') as f:
        with open(os.path.join('/home/data1/my/Project/yolov5/runs/detect/exp/labels/', name + '.txt'), 'r') as f:
            ...
            for box_idx, line in enumerate(lines):
                ...
                boxes_orig_scale[box_idx] = np.array([minx,miny, maxx, maxy])
        ...
        for i in range(batch_num):
            ...
            for ind in range(upscaled_masks.shape[0]):
                image_mask[upscaled_masks[ind] == 1] = 1
        ...
        if eval_flag:
            ...
            for box in boxes_orig_scale:
                cv2.rectangle(pred_vis, (int(box[1]), int(box[0])), (int(box[3]), int(box[2])), (0, 0, 255), 3)
